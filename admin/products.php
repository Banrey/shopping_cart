    ...
    <div class="container border">
        ...
        <div class="row p-2">
            ...
            <div class="col-sm-7 ">
                <div class="form-group">
                                        <label>Product *</label>   
                                        <input value="<?php echo $txt_product_name ?>" type="text" id="product_name" class="form-control rounded" placeholder="Product Name" > 
            ...
            <div class="col-sm-4 ">
                <div class="form-group">
                                        <label>Price *</label>   
                                        <input value="<?php echo $txt_price ?>" type="price" id="price" class="form-control rounded text-end" placeholder="0.00 Php" > 
            ...
            <div class="col-sm-4 ">
                <div class="form-group">
                                        ...
                                        <input value="<?php echo $txt_dimensions ?>" type="text" id="dimensions" class="form-control rounded" placeholder="Dimensions" > 
            ...
            <div class="col-sm-4 ">
                <div class="form-group">
                                        <label>Color</label>   
                                        <input value="<?php echo $txt_color ?>" type="text" id="color" class="form-control rounded" placeholder="Color" > 
            ...
            <div class="col-sm-4 ">
                <div class="form-group">
                                        <label>Qty *</label>   
                                        <input value="<?php echo $txt_qty ?>" type="text" id="qty" class="form-control rounded text-end" placeholder="0" > 
            ...
            <div class="col-sm-6 ">
                <div class="form-group">
                    <input type="hidden" value="<?php echo $txt_id; ?>" id="id" >
                            <button type="button" id="BtnAddProducts" class="btn btn-warning btn-block">Save Product Details</button>        
                </div>
            </div>
        ...
        <div>
			...
			<table border="1" class="table table-striped">
					...
					<tbody>
						...
						<?php $ctr++; ?>
						<tr>
							<td> <a href="process.product.php?action=delete&id=<?php echo $get_products["ID"] ?>"> 
							Delete</a> /
							<a href="products.php?action=update&id=<?php echo $get_products["ID"] ?>">
							Update</a> /
