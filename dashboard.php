...
<div class="container-fluid">
	...
	<div class="row p-2">
		<div class="col-sm-12 text-end">
			<h3> Welcome
				<?php echo $_SESSION['first_name'] ?> to your dashboard
			</h3>
		</div>
	</div>
	<div class="row p-2">
		<div class="col-sm-12 text-end">
			...
			<table border="1" class="table table-striped">
				...
				<tbody>
					...
					<?php while ($get_products = mysqli_fetch_array($qry_products)) { ?>
						...
						<tr>
							...
							<td>
								<?php echo $get_products["category"] ?>
							</td>
							<td class="text-end">
								<?php echo $get_products["price"] ?>
							</td>
							<td class="text-end">
								<?php echo $get_products["qty"] ?>
							</td>
							<td class="text-end">
								<?php echo number_format(($get_products["qty"] * $get_products["price"]), 2) ?>
							</td>
							<td>
								<?php echo (($get_products["status"] == 0) ? "Pending" : "Delivered") ?>
							</td>
						</tr>
					<?php } ?>
				</tbody>
				<tfoot>
					<tr>
						<td colspan="3">Total Products Purchased :
							<?php echo $ctr; ?>
						</td>
					</tr>
				</tfoot>
