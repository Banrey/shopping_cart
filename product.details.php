...
include("connect.php");
	...
	FROM products AS pr JOIN categories AS ca ON ca.ID = pr.category_id WHERE pr.ID = ? ORDER BY pr.product_name ASC";
...
<div class="container-fluid">
	...
	<div class="row mt-2">
		<div class="col-sm-12">
			<button type="button" id="BtnAddToCart" class="btn btn-warning btn-block">Add to Cart</button>
		</div>	
	</div>
	<?php } ?>
		<div class="row mt-2">
